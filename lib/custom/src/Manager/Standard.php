...
/**
 * Delivery and payment sardes manager.
 *
 * @package MShop
 * @subpackage Sardes
 */
class Standard
	extends \Aimeos\MShop\Sardes\Manager\Base
	implements \Aimeos\MShop\Sardes\Manager\Iface, \Aimeos\MShop\Common\Manager\Factory\Iface
{
	...
	public function __construct( \Aimeos\MShop\Context\Item\Iface $context )
	{
		...
		$this->setResourceName( 'db-sardes' );
		$this->date = $context->getDateTime();
		$level = \Aimeos\MShop\Locale\Manager\Base::SITE_ALL;
		$level = $context->getConfig()->get( 'sardes/manager/sitemode', $level );
	 ...
	 * @return \Aimeos\MShop\Sardes\Manager\Iface Manager object for chaining method calls
	 */
	...
	/**
	 * Returns the sardes item specified by the given ID.
	 *
	 * @param string $id Unique ID of the sardes item
	 * @param string[] $ref List of domains to fetch list items and referenced items for
	 * @param bool $default Add default criteria
	 * @return \Aimeos\MShop\Sardes\Item\Iface Returns the sardes item of the given id
	...
	/**
	 * Adds a new or updates an existing sardes item in the storage.
	 *
	 * @param \Aimeos\MShop\Sardes\Item\Iface $item New or existing sardes item that should be saved to the storage
	...
	/**
	 * Searches for sardes items based on the given criteria.
	 *
	 * @param \Aimeos\MW\Criteria\Iface $search Search criteria object
	 * @param string[] $ref List of domains to fetch list items and referenced items for
	 * @param int|null &$total Number of items that are available in total
	 * @return \Aimeos\Map List of items implementing \Aimeos\MShop\Sardes\Item\Iface with ids as keys
	 */
