	...
	implements \Aimeos\MShop\Common\Factory\Iface
{
	 ...
	 * @throws \Aimeos\MShop\Frigian\Exception|\Aimeos\MShop\Exception If requested manager
	...
	{
		if( $name === null ) {
			$name = $context->getConfig()->get( 'frigian/manager/name', 'Standard' );
		}

		$iface = \Aimeos\MShop\Frigian\Manager\Iface::class;
		$classname = '\Aimeos\MShop\Frigian\Manager\\' . $name;
		...
		return self::addManagerDecorators( $context, $manager, 'frigian' );
	}
