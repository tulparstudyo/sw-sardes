...
<head>
    ...
    <style type="text/css" media="screen">
        ...
        a { color:#E9C7C6; text-decoration:none }
        ...
        .l-pink a { color: #E9C7C6; }
        .l-grey a { color: #6e6e6e; }
        .l-purple a { color: #9128df; }

        .gradient { background: linear-gradient(to right, #E9C7C6 0%,#E9C7C6 100%); }

        .btn-secondary { border-radius: 10px; background: linear-gradient(to right, #E9C7C6 0%,#E9C7C6 100%); }
                                                                                        ...
                                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                            <tr>
                                                                                                <td class="pb-30" style="padding-bottom: 30px;">
                                                                                                    ...
                                                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                        <tr>
                                                                                                            <td class="btn-20 btn-secondary c-white l-white" bgcolor="#E9C7C6" style="font-size:20px; line-height:24px; mso-padding-alt:15px 35px; font-family:'PT Sans', Arial, sans-serif; text-align:center; font-weight:bold; text-transform:uppercase; min-width:auto !important; border-radius:10px; background:linear-gradient(to right, #E9C7C6 0%,#E9C7C6 100%); color:#ffffff;">
                                                                                                                <a href="<?=url()->current()."/$locale/$currency/profile"?>" target="_blank" class="link c-white" style="display: block; padding: 15px 35px; text-decoration:none; color:#ffffff;">
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        <td align="left" style="font-size:0px;padding:inherit;word-break:break-word;">
                                                                                                                            <div style="font-size: 20px ; line-height: 24px ; color: #282828 ; font-family:'PT Sans', Arial, sans-serif; text-align: left ; min-width: auto ; padding-bottom: 10px">
                                                                                                                                ...
                                                                                                                                <div class="content" style="font-size:16px; color:#6e6e6e; font-family:'PT Sans', Arial, sans-serif; text-align:left; min-width:auto !important; line-height: 10px; padding-bottom: 15px;">
                                                                                            ...
                                                                                            <tr>
                                                                                                <td align="center">
                                                                                                    ...
                                                                                                    <table border="0" cellspacing="0" cellpadding="0" style="min-width: 200px;">
                                                                                                        <tr>
                                                                                                            <td class="btn-16 c-white l-white" bgcolor="#E9C7C6" style="font-size:16px; line-height:20px; mso-padding-alt:15px 35px; font-family:'PT Sans', Arial, sans-serif; text-align:center; font-weight:bold; text-transform:uppercase; border-radius:25px; min-width:auto !important; color:#ffffff;">
                                          <a href="<?=url()->current()."/$locale/$currency/profile"?>" target="_blank" class="link c-white" style="display: block; padding: 15px 35px; text-decoration:none; color:#ffffff;">
