                        ...
                        <div class="footer__about">
                            <div class="footer__logo">
                                <a href="index.html" class="footer__logo-link">
                                    <img src="<?=sardes_url('assets/img/logo/logo.png')?>" alt="" class="footer__logo-img">
                                </a>
                            </div>
                            <ul class="footer__address">
                                <li class="footer__address-item"><i class="fa fa-home"></i>
                                <?php echo sardes_option('store_address')?></li>
                                <li class="footer__address-item"><i class="fa fa-phone-alt"></i>
                                <?php echo sardes_option('store_phone')?></li>
                                <li class="footer__address-item"><i class="fa fa-envelope"></i>  
                                <?php echo sardes_option('store_email')?></li>
                            </ul>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        ...
                        <div class="footer__payment">
                            <a href="#" class="footer__payment-link">
                                <img src="<?=sardes_url('assets/img/company-logo/payment.png')?>" alt="" class="footer__payment-img">
                            </a>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            <div class="col-md-7">
              <div class="row">
                <div class="col-md-4">
                  <div class="modal__product-img"> <img class="img-fluid" src="<?=sardes_url('assets/img/product/size-normal/product-home-1-img-1.jpg')?>" alt=""> </div>
                </div>
                <div class="col-md-8">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="product-gallery-box m-b-60">
                <div class="modal-product-image--large"> <img class="img-fluid" src="<?=sardes_url('assets/img/product/gallery/gallery-large/product-gallery-large-1.jpg')?>" alt=""> </div>
              </div>
            </div>
            <div class="col-md-6">
