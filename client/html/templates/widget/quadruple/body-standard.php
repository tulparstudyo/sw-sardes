...
<div class="for-mobile">
    ...
    <div class="m-main-block">
        <img src="<?= sardes_url('assets/img/menu-mobil/m-pattern-01.gif') ?>" alt="">
        <a href="/#">
            <span><?=$this->translate( 'client', 'Recommended Products' )?></span>
        </a>
    </div>
    <div class="m-main-block">
        <img src="<?= sardes_url('assets/img/menu-mobil/m-pattern-02.gif') ?>" alt="">
    ...
    <div class="m-main-block">
        <img src="<?= sardes_url('assets/img/menu-mobil/m-pattern-03.gif') ?>" alt="">
