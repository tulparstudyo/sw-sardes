...
<?php if( $this->get( 'priceHigh', 0 ) ) : ?>
    ...
    <div class="sidebar__box">
        <h5 class="kenne-categories_title">                       
		...
		<div class="price-lists">
			...
			<fieldset>
				...
				<button type="submit" class="btn btnfilter_save "><?= $enc->html( $this->translate( 'client', 'Save' ) ) ?></button>
				<?php if( $this->param( 'f_price' ) ) : ?>
				<a  class="btn btnfilter_save" href="<?= $enc->attr( $this->url( $target, $cntl, $action, $this->get( 'priceResetParams', [] ), [], $config ) ); ?>">
