...
<?php endif; ?>
	...
	$url = "/$locale/$currency/home"?>
                    ...
                    <div class="offcanvas-inner_logo"> <a href="<?=$url?>"> <img src="<?=sardes_url('/assets/img/palto-logo.png')?>" alt="Header Logo" style="max-width: 100%;"> </a> </div>
