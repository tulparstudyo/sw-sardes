...
<div class="section-content">
    	<h5 class="section-content__title">	<?= $enc->html( $this->translate( 'client', 'Delivery address' ), $enc::TRUST ); ?></h5>
	</div> 


	<div class="item-address item-like">
		<div class="header gray-bg">
			<input id="ca_deliveryoption-like" type="radio" value="like" class="shipping-select"
	...
	<?php if( !$this->config( 'client/html/common/address/delivery/disable-new', false ) ) : ?>
		...
		<div class="item-address item-new" data-option="<?= $enc->attr( $this->get( 'addressDeliveryOption' ) ); ?>">
			<div class="header gray-bg">
				<input id="ca_deliveryoption-null" type="radio" value="null" class="shipping-select"
					name="<?= $enc->attr( $this->formparam( ['ca_deliveryoption'] ) ); ?>"
