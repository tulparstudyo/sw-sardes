...
namespace Aimeos\Client\Html\Swordbros\Frigian\Footer;
	...
	implements \Aimeos\Client\Html\Common\Factory\Iface
{
    ...
    if( $name === null ) {
		...
		$classname = '\\Aimeos\\Client\\Html\\Swordbros\\Frigian\\Footer\\' . $name;
		...
		$client = self::addClientDecorators( $context, $client, 'frigian/footer' );
