...
namespace Aimeos\Client\Html\Swordbros\Sardes\Footer;
	...
	implements \Aimeos\Client\Html\Common\Factory\Iface
{
    ...
    if( $name === null ) {
		...
		$classname = '\\Aimeos\\Client\\Html\\Swordbros\\Sardes\\Footer\\' . $name;
		...
		$client = self::addClientDecorators( $context, $client, 'sardes/footer' );
