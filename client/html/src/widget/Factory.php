...
namespace Aimeos\Client\Html\Swordbros\Sardes\Widget;
	...
	implements \Aimeos\Client\Html\Common\Factory\Iface
{
    ...
    if( $name === null ) {
		...
		$classname = '\\Aimeos\\Client\\Html\\Swordbros\\Sardes\\Widget\\' . $name;
		...
		$client = self::addClientDecorators( $context, $client, 'sardes/widget' );
